...
- 🔒 **داده‌های مالی آفلاین** — هیچ دادهٔ مالی به سرور ارسال نمی‌شود؛ اطلاعات شما فقط روی دستگاه خودتان است
- 🔄 **نرخ اختیاری** — فقط بخش ابزارها، وقتی شما بروزرسانی را بزنید، به منابع عمومی نرخ وصل می‌شود (بدون داده شخصی)
...
| اپ به اینترنت وصل می‌شود؟ | برای دادهٔ مالی **هرگز** — بدون تحلیل/ردیابی/تبلیغ؛ فقط بخش اختیاری «ابزارها» برای واکشی نرخ عمومی می‌تواند وصل شود |
...
- 🔒 **Offline financial data** — no financial data ever goes to a server; your data stays on your device only
- 🔄 **Optional rates** — only the Tools page may reach public rate sources when you press Refresh (no personal data)
...
| Does the app connect to the internet? | **Never for your financial data** — no analytics/tracking/ads; only the optional Tools page may reach public rate sources |
